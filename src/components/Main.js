...
const Main = () => {
  return (
    <div className="px-[25px] pt-[25px] w-full sticky bg-[#F8F9FC] pb-[40px] mx-auto">
      ...
      <div className="sm:flex flex-col md:grid grid-cols-4 gap-[30px] mt-[25px] pb-[15px]">
      ...
      <div className="flex flex-col md:flex-row mt-[22px] w-fit gap-[30px]  overflow-x-scroll no-scrollbar">
        <div className="basis-full lg:basis-[100%] w-fit border bg-white shadow-md cursor-pointer rounded-[4px]">
        ...
        <div className="basis-full lg:basis-[100%]  border bg-white shadow-md cursor-pointer rounded-[4px]">
      ...
      <div className="flex flex-col md:flex-row mt-[22px] w-full gap-[30px]">
